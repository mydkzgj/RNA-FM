...
def choose_backbone(backbone_name):
    ...
    if backbone_name == 'esm1b':
        backbone, backbone_alphabet = my_esm.pretrained.esm1b_t33_650M_UR50S()
        #backbone_batch_converter = backbone_alphabet.get_batch_converter()
    elif backbone_name == 'esm1b-rna':
        backbone, backbone_alphabet = my_esm.pretrained.esm1b_rna_t12()

    elif backbone_name == 'esm1':
        backbone, backbone_alphabet = my_esm.pretrained.esm1_t6_43M_UR50S()

    # 2.MSA Transformer
    elif backbone_name == 'msa_transformer':
        backbone, backbone_alphabet = my_esm.pretrained.esm_msa1_t12_100M_UR50S()
    else:
